            ...
            <div class="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
                <div class="text-center">
                    <h1 class="text-4xl md:text-6xl font-bold text-white mb-6">
                        {{ content('hero_title', 'Master Clinical Nephrology with Expert-Crafted Scenarios') }}
                    </h1>
                    <p class="text-xl text-blue-100 mb-8 max-w-3xl mx-auto leading-relaxed">
                        {{ content('hero_subtitle', 'Dive deep into real-world nephrology cases with interactive scenarios designed by leading experts. Perfect your clinical reasoning and diagnostic skills.') }}
                    </p>
                    <div class="flex flex-col sm:flex-row gap-4 justify-center">
                        <button class="inline-flex items-center px-8 py-4 bg-white text-blue-600 font-semibold rounded-xl hover:bg-blue-50 transform hover:scale-105 transition-all duration-200 shadow-lg">
                            ...
                            {{ content('hero_cta_primary', 'Get Started') }}
                        </button>
                        <button class="inline-flex items-center px-8 py-4 bg-transparent border-2 border-white text-white font-semibold rounded-xl hover:bg-white hover:text-blue-600 transform hover:scale-105 transition-all duration-200">
                            ...
                            {{ content('hero_cta_secondary', 'View Topics') }}
                        </button>
                    </div>
                </div>
            </div>
        ...
        <div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6 mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
                    ...
                    <!-- Search Filter -->
                    <div>
                        <label class="block text-sm font-medium text-slate-700 mb-2">{{ content('topics_search_label', 'Search Topics') }}</label>
                        <div class="relative">
                            <input type="text" 
                                   id="topic-search" 
                                   ...
                                   placeholder="{{ content('topics_search_filter_placeholder', 'Search by title, content...') }}"
                                   value="{{ request('q') }}">
                    ...
                    <!-- Category Filter -->
                    <div>
                        <label class="block text-sm font-medium text-slate-700 mb-2">{{ content('topics_category_label', 'Category') }}</label>
                        <select id="category-filter" class="w-full px-4 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200">
                            <option value="">{{ content('topics_all_categories_option', 'All Categories') }}</option>
            ...
            <div id="topics-grid" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                @forelse($topics as $topic)
                    <div class="topic-card bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden hover:shadow-lg transform hover:-translate-y-1 transition-all duration-300" 
                         data-category="{{ $topic->category->name ?? 'Uncategorized' }}"
                         data-title="{{ strtolower($topic->title) }}"
                         data-date="{{ $topic->published_at?->format('Y-m-d') }}">
                        ...
                        <div class="p-6 pb-4">
                            ...
                            <h3 class="text-lg font-semibold text-slate-900 mb-2">
                                <a href="{{ route('topics.show', $topic) }}" class="hover:text-blue-600 transition-colors duration-200">
                                    {{ $topic->title }}
                                </a>
                            </h3>
                        ...
                        <div class="px-6 py-4 bg-slate-50 border-t border-slate-100">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center text-xs text-slate-500">
                                    ...
                                    {{ $topic->published_at?->diffForHumans() ?? 'Draft' }}
                                </div>
                                <a href="{{ route('topics.show', $topic) }}" class="inline-flex items-center justify-center w-10 h-10 bg-gradient-to-br from-blue-500 to-purple-600 text-white rounded-full hover:from-blue-600 hover:to-purple-700 transition-all duration-300 hover:scale-110 shadow-lg hover:shadow-xl" title="View Topic">
                ...
                @empty
                    <div class="col-span-full">
                        <div class="text-center py-12">
                            ...
                            <h3 class="mt-4 text-lg font-medium text-slate-900">{{ content('topics_no_results_title', 'No topics found') }}</h3>
                            <p class="mt-2 text-slate-500">{{ content('topics_no_results_description', 'Get started by creating your first topic.') }}</p>
