            ...
            <div class="relative z-10 flex items-center justify-between py-8">
                <div class="text-white">
                    ...
                    <p class="text-green-100 mt-2 animate-slide-up">
                        {{ $stats['completed_count'] }} completed topics
                    </p>
                </div>
                ...
                <div class="flex items-center space-x-4">
                    <div class="text-right text-white">
                        <div class="text-2xl font-bold">{{ $stats['completed_count'] }}</div>
                                    ...
                                    <div class="group relative overflow-hidden rounded-2xl p-6 bg-white shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105 hover:-translate-y-2 border border-gray-200">
                                        ...
                                        <div class="relative z-10">
                                            ...
                                            <div class="text-xs text-gray-500 mb-4">
                                                Completed {{ $topic->pivot->completed_at instanceof \Carbon\Carbon ? $topic->pivot->completed_at->diffForHumans() : \Carbon\Carbon::parse($topic->pivot->completed_at)->diffForHumans() }}
                                            </div>

                                            <!-- Notes (if any) -->
                                            @if($topic->pivot->notes)
                                                <div class="bg-gray-50 rounded-md p-3 mb-4">
                                                    <p class="text-sm text-gray-700">
                                                        <strong>Notes:</strong> {{ $topic->pivot->notes }}
                                                    </p>
                                                </div>
                                            @endif
