...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center justify-between">
            ...
            <a href="<?php echo e(route('admin.layout-templates.create')); ?>" 
                                    ...
                                    <div class="p-6">
                                        ...
                                        <div class="flex items-center justify-between">
                                            <div class="flex space-x-2">
                                                <a href="<?php echo e(route('admin.layout-templates.show', $template)); ?>" 
                                                   class="text-blue-600 hover:text-blue-800 text-sm font-medium">
                                                    View
                                                </a>
                                                <a href="<?php echo e(route('admin.layout-templates.edit', $template)); ?>" 
                                                   class="text-green-600 hover:text-green-800 text-sm font-medium">
                                                    Edit
                                                </a>
                                                <a href="<?php echo e(route('admin.layout-templates.preview', $template)); ?>" 
                                                   class="text-purple-600 hover:text-purple-800 text-sm font-medium" target="_blank">
                                                    Preview
                                                </a>
                                            </div>
                                            
                                            <form method="POST" action="<?php echo e(route('admin.layout-templates.destroy', $template)); ?>" 
...
<?php endif; ?>
<?php /**PATH /homepages/38/d4299336130/htdocs/nephroapp/resources/views/admin/layout-templates/index.blade.php ENDPATH**/ ?>