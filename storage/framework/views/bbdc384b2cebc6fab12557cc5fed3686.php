                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-6">
                                <div>
                                    ...
                                    <input type="text" name="name" id="name" value="<?php echo e(old('name', $template->name)); ?>" 
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <textarea name="description" id="description" rows="3" 
                                              class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"><?php echo e(old('description', $template->description)); ?></textarea>
                                </div>
                                ...
                                <div>
                                    ...
                                    <select name="category" id="category" 
                                        ...
                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($category); ?>" <?php echo e(old('category', $template->category) == $category ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="order" id="order" value="<?php echo e(old('order', $template->order)); ?>" min="0"
                                ...
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div class="flex items-center">
                                        <input type="checkbox" name="is_default" id="is_default" value="1" 
                                               <?php echo e(old('is_default', $template->is_default) ? 'checked' : ''); ?>
                            ...
                            <div class="space-y-6">
                                <div>
                                    ...
                                    <textarea name="html_content" id="html_content" rows="10" 
                                              ...
                                              placeholder="Enter your HTML template here. Use <?php echo '<?php echo e(variable_name); ?>'; ?> for dynamic content." required><?php echo e(old('html_content', $template->html_content)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <textarea name="css_content" id="css_content" rows="8" 
                                              class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 font-mono text-sm" 
                                              placeholder="Enter your CSS styles here."><?php echo e(old('css_content', $template->css_content)); ?></textarea>
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea name="js_content" id="js_content" rows="6" 
                                              class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 font-mono text-sm" 
                                              placeholder="Enter your JavaScript code here."><?php echo e(old('js_content', $template->js_content)); ?></textarea>
                                </div>
                            </div>
                        </div>
...
<?php endif; ?>
<?php /**PATH /homepages/38/d4299336130/htdocs/nephroapp/resources/views/admin/templates/edit.blade.php ENDPATH**/ ?>