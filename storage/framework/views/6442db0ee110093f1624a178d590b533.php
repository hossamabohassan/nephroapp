...
<?php endif; ?>
    ...
    <?php if($allowGoogleAuth): ?>
        <div class="mb-6">
            <a href="<?php echo e(route('auth.google.redirect')); ?>" class="inline-flex w-full items-center justify-center gap-3 rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition">
...
<?php endif; ?>
    ...
    <?php if($allowEmailRegistration): ?>
        <p class="mt-6 text-center text-sm text-gray-600">
            ...
            <a href="<?php echo e(route('register')); ?>" class="font-semibold text-indigo-600 hover:text-indigo-500"><?php echo e(__('Create one')); ?></a>
        </p>
    <?php endif; ?>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /homepages/38/d4299336130/htdocs/nephroapp/resources/views/auth/login.blade.php ENDPATH**/ ?>