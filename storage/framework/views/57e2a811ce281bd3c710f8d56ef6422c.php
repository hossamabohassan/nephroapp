    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div class="flex items-center gap-3">
                ...
                <form method="POST" action="<?php echo e(route('admin.landing-page.reset')); ?>" class="inline" onsubmit="return confirm('Are you sure you want to reset to the original file content? This will overwrite any unsaved changes.')">
                    <?php echo csrf_field(); ?>
        ...
        <!-- Editor Form -->
        <form method="POST" action="<?php echo e(route('admin.landing-page.update')); ?>" class="space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-slate-200">
                ...
                <div class="p-4">
                    ...
                    ><?php echo e(old('html_content', $htmlContent)); ?></textarea>
                </div>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            previewBtn.addEventListener('click', function() {
                ...
                const previewUrl = '<?php echo e(route("admin.landing-page.preview")); ?>';
...
<?php endif; ?>
<?php /**PATH /homepages/38/d4299336130/htdocs/nephroapp/resources/views/admin/landing-page/index.blade.php ENDPATH**/ ?>