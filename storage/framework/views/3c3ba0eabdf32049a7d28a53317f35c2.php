...
<head>
    ...
    <title>Interactive Preview - <?php echo e($template->name); ?></title>
...
<body class="font-sans antialiased">
    ...
    <div class="toolbar">
        <div class="flex items-center justify-between">
            <div class="flex items-center space-x-4">
                <h1 class="text-lg font-semibold">Interactive Preview - <?php echo e($template->name); ?></h1>
            ...
            <div class="flex items-center space-x-2">
                ...
                <a href="<?php echo e(route('admin.templates.edit', $template)); ?>" class="bg-gray-600 hover:bg-gray-700 px-4 py-2 rounded">
                    Back to Edit
                </a>
            </div>
        </div>
    ...
    <div id="variablesPanel" class="variables-panel">
        ...
        <?php $__currentLoopData = $allVariables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="variable-item" data-variable="<?php echo e($key); ?>">
                <div class="flex items-center justify-between">
                    <div>
                        <div class="font-medium text-sm"><?php echo e($key); ?></div>
                        <div class="text-xs text-gray-500 truncate">
                            <?php echo e(is_string($value) ? Str::limit(strip_tags($value), 50) : 'Complex Value'); ?>

                        </div>
                    </div>
                    <button class="edit-variable text-blue-600 hover:text-blue-800 text-sm" data-variable="<?php echo e($key); ?>">
                        Edit
                    </button>
                </div>
            </div>
    ...
    <form id="saveForm" action="<?php echo e(route('admin.templates.save-preview', $template)); ?>" method="POST" style="display: none;">
        <?php echo csrf_field(); ?>
    ...
    <div class="bg-yellow-100 p-4 mb-4 rounded">
        ...
        <p><strong>Template Variables Count:</strong> <?php echo e(count($template->variables ?? [])); ?></p>
        <p><strong>All Variables Count:</strong> <?php echo e(count($allVariables)); ?></p>
        <p><strong>Sample Variables:</strong> <?php echo e(json_encode(array_keys($allVariables))); ?></p>
    </div>
    ...
    <script>
        let editMode = false;
        let currentVariables = <?php echo json_encode($allVariables, 15, 512) ?>;
        let originalHtml = <?php echo json_encode($template->html_content, 15, 512) ?>;
        ...
        function renderTemplate() {
            ...
            Object.entries(currentVariables).forEach(([key, value]) => {
                const placeholder = '<?php echo e(' + key + '); ?>';
        ...
        function saveChanges() {
            ...
            Object.keys(currentVariables).forEach(variableName => {
                ...
                const placeholder = '<?php echo e(' + variableName + '); ?>';
            ...
            // Send to server
            fetch(`<?php echo e(route('admin.templates.save-preview', $template)); ?>`, {
                method: 'POST',
                headers: {
...
<?php /**PATH /homepages/38/d4299336130/htdocs/nephroapp/resources/views/admin/templates/interactive-preview.blade.php ENDPATH**/ ?>