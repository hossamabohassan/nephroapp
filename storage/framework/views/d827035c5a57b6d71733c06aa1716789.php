...
<?php $component->withAttributes([]); ?>
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <div class="flex items-center gap-3 text-sm">
            ...
            <a href="<?php echo e(route('admin.topics.show', $topic)); ?>" class="inline-flex items-center px-3 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
                <?php echo e(__('Admin Preview')); ?>
    ...
    <div class="space-y-6" id="topicStudio" data-preview-url="<?php echo e(route('admin.topics.preview')); ?>">
        ...
        <div class="grid gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(0,0.9fr)]">
            <div class="bg-white p-6 rounded-xl shadow-sm border border-slate-200 space-y-6">
                    <form method="POST" action="<?php echo e(route('admin.topics.update', $topic)); ?>" class="space-y-6" id="topicForm">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>

                        <div class="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                            <div class="text-sm text-gray-500">
                                <?php echo e(__('Update the structured data, preview changes instantly, then publish when ready.')); ?>
                            ...
                            <div class="flex gap-2">
                                <button type="button" id="autofillFromJson" class="inline-flex items-center px-3 py-2 border border-indigo-200 text-sm font-medium rounded-md text-indigo-600 bg-white hover:bg-indigo-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                    <?php echo e(__('Refresh from JSON')); ?>
                        ...
                        <div>
                            ...
                            <textarea id="data" name="data" rows="16" class="mt-1 font-mono text-sm block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required><?php echo e(old('data', $dataJson)); ?></textarea>
...
<?php endif; ?>
                        ...
                        <div class="grid gap-6 md:grid-cols-2">
                            <div>
                                ...
                                <input id="title" name="title" type="text" value="<?php echo e(old('title', $topic->title)); ?>" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" autocomplete="off" required>
                                <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
...
<?php endif; ?>
                            ...
                            <div>
                                ...
                                <input id="slug" name="slug" type="text" value="<?php echo e(old('slug', $topic->slug)); ?>" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" autocomplete="off" required>
                                <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
...
<?php endif; ?>
                            ...
                            <div>
                                ...
                                <input id="subtitle" name="subtitle" type="text" value="<?php echo e(old('subtitle', $topic->subtitle)); ?>" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
...
<?php endif; ?>
                            ...
                            <div>
                                ...
                                <select id="status" name="status" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                    <option value="draft" <?php if(old('status', $topic->status) === 'draft'): echo 'selected'; endif; ?>><?php echo e(__('Draft')); ?></option>
                                    <option value="review" <?php if(old('status', $topic->status) === 'review'): echo 'selected'; endif; ?>><?php echo e(__('Review')); ?></option>
                                    <option value="published" <?php if(old('status', $topic->status) === 'published'): echo 'selected'; endif; ?>><?php echo e(__('Published')); ?></option>
                                </select>
                                <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
                            ...
                            <div>
                                ...
                                <select id="template_id" name="template_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                    ...
                                    <?php $__currentLoopData = $templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($template->id); ?>" <?php if(old('template_id', $topic->template_id) == $template->id): echo 'selected'; endif; ?>><?php echo e($template->name); ?></option>
                            ...
                            <div>
                                ...
                                <select id="category_id" name="category_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                    ...
                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($category->id); ?>" <?php if(old('category_id', $topic->category_id) == $category->id): echo 'selected'; endif; ?>><?php echo e($category->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                                <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
...
<?php endif; ?>
                            ...
                            <div>
                                ...
                                <textarea id="summary" name="summary" rows="4" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"><?php echo e(old('summary', $topic->summary)); ?></textarea>
                                <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
...
<?php endif; ?>
                        ...
                        <div>
                            ...
                            <textarea id="meta" name="meta" rows="6" class="mt-1 font-mono text-sm block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"><?php echo e(old('meta', $metaJson)); ?></textarea>
                            <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
...
<?php endif; ?>
                        ...
                        <div class="flex items-center justify-between">
                            <label class="inline-flex items-center">
                                <input type="checkbox" name="publish" value="1" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" <?php if(old('publish', $topic->status === \App\Models\Topic::STATUS_PUBLISHED)): echo 'checked'; endif; ?>>
                                <span class="ms-2 text-sm text-gray-700"><?php echo e(__('Publish now')); ?></span>
                            </label>
            ...
            <div class="bg-white p-6 rounded-xl shadow-sm border border-slate-200 flex flex-col gap-4">
                    <div>
                        ...
                        <p class="text-sm text-gray-500"><?php echo e(__('Run a preview after editing the JSON to verify the rendered layout.')); ?></p>
                    </div>
        ...
        <?php if($topic->status !== \App\Models\Topic::STATUS_PUBLISHED): ?>
            <div class="bg-white p-6 rounded-xl shadow-sm border border-slate-200 flex items-center justify-between">
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900"><?php echo e(__('Danger zone')); ?></h3>
                        <p class="text-sm text-gray-500"><?php echo e(__('Drafts and review topics can be deleted permanently from here.')); ?></p>
                    </div>
                    <form method="POST" action="<?php echo e(route('admin.topics.destroy', $topic)); ?>" onsubmit="return confirm('<?php echo e(__('Are you sure? This cannot be undone.')); ?>');">
                        <?php echo csrf_field(); ?>
...
<?php /**PATH /homepages/38/d4299336130/htdocs/nephroapp/resources/views/admin/topics/edit.blade.php ENDPATH**/ ?>