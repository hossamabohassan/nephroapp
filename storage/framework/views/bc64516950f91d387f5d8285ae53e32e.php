...
<body class="edit-mode">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            console.log('Has rendered_html?', <?php echo e($topic->rendered_html ? 'true' : 'false'); ?>);
            console.log('Rendered at:', '<?php echo e($topic->rendered_at); ?>');
            console.log('Updated at:', '<?php echo e($topic->updated_at); ?>');
        });
        ...
        previewBtn.addEventListener('click', () => {
            ...
            const htmlDoc = `
                ...
                <head>
                    ...
                    <title>Preview - <?php echo e($topic->title); ?></title>
                </head>
                <body>
                    ${cleanContent}
                </body>
...
<?php /**PATH /homepages/38/d4299336130/htdocs/nephroapp/resources/views/admin/topics/wysiwyg-vivatemplate.blade.php ENDPATH**/ ?>