                        ...
                        <div class="space-y-1 mb-6">
                            <?php $__currentLoopData = $menuItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menuItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <a href="<?php echo e($menuItem->url); ?>" 
                                   class="group flex items-center px-4 py-3 rounded-xl text-sm  <?php echo e($isCurrentPage ? 'bg-blue-500 text-white' : 'text-slate-700 hover:bg-slate-100'); ?>"
                                   <?php if($menuItem->opens_in_new_tab): ?> target="_blank" <?php endif; ?>>
                                    <div class="w-8 h-8 rounded-lg flex items-center justify-center mr-3 flex-shrink-0 <?php echo e($isCurrentPage ? 'bg-white/20' : 'bg-slate-100 group-hover:bg-slate-200'); ?> ">
                                        <?php if($menuItem->icon === 'home'): ?>
                                            <svg class="w-4 h-4 <?php echo e($isCurrentPage ? 'text-white' : 'text-slate-600'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <span class="link-text truncate font-medium"><?php echo e($menuItem->title); ?></span>
                    ...
                    <div class="bg-white rounded-2xl border border-slate-200 p-8 md:p-10 mb-8 relative">
                        ...
                        <div class="relative z-10">
                            ...
                            <div class="flex flex-wrap gap-3 mb-6">
                                ...
                                <?php $__currentLoopData = array_filter([$topic->data['CHIP_1'] ?? null, $topic->data['CHIP_2'] ?? null, $topic->data['CHIP_3'] ?? null]); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php if($topic->published_at): ?>
                                    <div class="flex items-center text-slate-600">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-slate-500"><?php echo e($topic->published_at->format('M d, Y')); ?></div>
                                        </div>
                                    </div>
                                <?php endif; ?>
                                <div class="flex items-center text-slate-600">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-slate-500"><?php echo e($topic->updated_at->format('M d, Y')); ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php if(isset($navigationSections) && count($navigationSections) > 0): ?>
...
<div id="nav-overlay" style="position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: #3b82f6; z-index: 9998; display: none;">
    ...
    <div style="max-width: 1400px; margin: 0 auto; padding: 0 20px 20px; display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 12px; height: calc(100vh - 140px); overflow: hidden;">
        <?php $__currentLoopData = $navigationSections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="#<?php echo e($section['id']); ?>" 
               ...
               style="display: flex; flex-direction: column; justify-content: center; align-items: center; text-align: center; padding: 12px; background: rgba(255,255,255,0.15); border-radius: 12px; text-decoration: none; color: white; border: 1px solid rgba(255,255,255,0.2); position: relative; overflow: hidden; min-height: 100px;">
                ...
                <!-- Section Content -->
                <div>
                    <h3 style="font-size: 1rem; font-weight: 600; margin: 0 0 4px 0; text-shadow: 0 1px 3px rgba(0,0,0,0.3); line-height: 1.2;"><?php echo e($section['title']); ?></h3>
                    <p style="font-size: 0.75rem; margin: 0; opacity: 0.7; font-weight: 300; line-height: 1.2;"><?php echo e($section['id']); ?></p>
                    </div>
    ...
    <script>
        ...
        function printArticle() {
            ...
            const printDocument = `
                ...
                <html>
                <head>
                    <title>Print - <?php echo e($topic->title); ?></title>
                    <style>
                        body {
                ...
                <body>
                    <div class="print-header">
                        <div class="print-title"><?php echo e($topic->title); ?></div>
                        <div class="print-subtitle"><?php echo e(config('app.name', 'NephroCoach')); ?> - <?php echo e(content('site_tagline', 'Expert Medical Training Platform')); ?></div>
...
<?php endif; ?><?php /**PATH /homepages/38/d4299336130/htdocs/nephroapp/resources/views/topics/show.blade.php ENDPATH**/ ?>