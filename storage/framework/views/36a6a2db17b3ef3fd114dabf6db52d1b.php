                            ...
                            <div class="space-y-6">
                                <div>
                                    ...
                                    <textarea name="html_content" id="html_content" rows="10" 
                                              ...
                                              placeholder="Enter your HTML template here. Use <?php echo '<?php echo e(variable_name); ?>'; ?> for dynamic content." required><?php echo e(old('html_content')); ?></textarea>
...
<?php endif; ?>
<?php /**PATH /homepages/38/d4299336130/htdocs/nephroapp/resources/views/admin/templates/create.blade.php ENDPATH**/ ?>