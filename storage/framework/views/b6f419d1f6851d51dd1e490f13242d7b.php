...
<?php $component->withAttributes([]); ?>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-slate-900"><?php echo e(\App\Models\User::where('role', 'admin')->count()); ?></p>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-slate-900"><?php echo e(\App\Models\User::where('role', 'editor')->count()); ?></p>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-slate-900"><?php echo e(\App\Models\User::where('role', 'member')->count()); ?></p>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <a href="<?php echo e(route('admin.users.index')); ?>" class="flex items-center p-4 border border-slate-200 rounded-lg hover:border-blue-300 hover:bg-blue-50 transition-colors group">
            ...
            <a href="<?php echo e(route('admin.users.create')); ?>" class="flex items-center p-4 border border-slate-200 rounded-lg hover:border-green-300 hover:bg-green-50 transition-colors group">
            ...
            <a href="<?php echo e(route('admin.activity.index')); ?>" class="flex items-center p-4 border border-slate-200 rounded-lg hover:border-purple-300 hover:bg-purple-50 transition-colors group">
...
<?php endif; ?>
<?php /**PATH /homepages/38/d4299336130/htdocs/nephroapp/resources/views/admin/permissions/index.blade.php ENDPATH**/ ?>