...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="relative overflow-hidden">
            <!-- Animated Background -->
            <div class="absolute inset-0 bg-gradient-to-r from-green-600 via-emerald-600 to-teal-600 opacity-90"></div>
            ...
            <div class="relative z-10 flex items-center justify-between py-8">
                <div class="text-white">
                    <h2 class="text-3xl font-bold bg-gradient-to-r from-white to-green-100 bg-clip-text text-transparent animate-fade-in">
                        <?php echo e(__('Completed Topics')); ?>

                    </h2>
                    <p class="text-green-100 mt-2 animate-slide-up">
                        <?php echo e($stats['completed_count']); ?> completed topics
                    </p>
                </div>
                ...
                <div class="flex items-center space-x-4">
                    <div class="text-right text-white">
                        <div class="text-2xl font-bold"><?php echo e($stats['completed_count']); ?></div>
                        <div class="text-sm text-green-100">Completed Topics</div>
                    </div>
    ...
    <div class="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                           ...
                           onmouseout="this.style.background='linear-gradient(135deg, #f3f4f6 0%, #e5e7eb 100%)'">
                            <div class="flex items-center space-x-3">
                                ...
                                <span class="text-white text-xs px-3 py-1 rounded-full shadow-lg animate-pulse border" 
                                      style="background-color: #ef4444; border-color: #fca5a5;"><?php echo e($stats['favorites_count']); ?></span>
                            </div>
                            <div class="absolute inset-0 bg-white/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-xl"></div>
                        </a>
                        ...
                        <a href="<?php echo e(route('profile.completed')); ?>" 
                           ...
                           style="background: linear-gradient(135deg, #10b981 0%, #059669 100%);">
                            <div class="flex items-center space-x-3">
                                ...
                                <span>Completed</span>
                                <span class="text-white text-xs px-3 py-1 rounded-full shadow-lg animate-pulse border" 
                                      style="background-color: #10b981; border-color: #6ee7b7;"><?php echo e($stats['completed_count']); ?></span>
                            </div>
                            <div class="absolute inset-0 bg-white/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-xl"></div>
                        </a>
                    </nav>
            ...
            <!-- Completed Overview Card with Animation -->
            <div class="mb-12 animate-fade-in-up">
                <div class="relative overflow-hidden bg-white/95 backdrop-blur-lg rounded-3xl shadow-2xl border border-gray-200">
                    ...
                    <div class="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-green-400/10 to-emerald-500/10 rounded-full -translate-y-32 translate-x-32 animate-pulse"></div>
                    <div class="absolute bottom-0 left-0 w-48 h-48 bg-gradient-to-tr from-emerald-400/10 to-teal-500/10 rounded-full translate-y-24 -translate-x-24 animate-bounce"></div>
                    ...
                    <div class="relative z-10 p-8">
                        <div class="flex flex-col lg:flex-row items-center space-y-6 lg:space-y-0 lg:space-x-8">
                            ...
                            <div class="flex-shrink-0 relative">
                                <div class="relative">
                                    <div class="absolute inset-0 bg-gradient-to-r from-green-500 to-emerald-600 rounded-full animate-ping opacity-75"></div>
                            ...
                            <!-- Completed Info with Animation -->
                            <div class="flex-1 text-center lg:text-left">
                                <h1 class="text-4xl font-bold text-gray-900 mb-2 animate-fade-in">
                                    Completed Topics
                                </h1>
                                <p class="text-gray-700 text-lg mb-1 animate-slide-up">Topics you've successfully completed</p>
                                <p class="text-gray-600 text-base mb-4 animate-slide-up">Track your learning progress and achievements</p>
                                ...
                                <div class="flex flex-wrap justify-center lg:justify-start gap-3 mb-6">
                                    <span class="inline-flex items-center px-4 py-2 rounded-full text-sm font-medium text-white shadow-lg animate-bounce"
                                        ...
                                        <?php echo e($stats['completed_count']); ?> Completed
                                    </span>
                                    <span class="inline-flex items-center px-4 py-2 rounded-full text-sm font-medium text-white shadow-lg animate-pulse"
                                        ...
                                        <?php echo e($stats['favorites_count']); ?> Favorites
                                    </span>
                                </div>
                            </div>
                    ...
                    <div class="relative z-10 p-8">
                        ...
                        <?php if($completed->count() > 0): ?>
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                <?php $__currentLoopData = $completed; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $topic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="group relative overflow-hidden rounded-2xl p-6 bg-white shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105 hover:-translate-y-2 border border-gray-200">
                                        ...
                                        <div class="relative z-10">
                                            ...
                                            <h4 class="text-lg font-semibold text-gray-900 mb-2 group-hover:text-green-600 transition-colors duration-200">
                                            ...
                                            <div class="text-xs text-gray-500 mb-4">
                                                Completed <?php echo e($topic->pivot->completed_at instanceof \Carbon\Carbon ? $topic->pivot->completed_at->diffForHumans() : \Carbon\Carbon::parse($topic->pivot->completed_at)->diffForHumans()); ?>

                                            </div>

                                            <!-- Notes (if any) -->
                                            <?php if($topic->pivot->notes): ?>
                                                <div class="bg-gray-50 rounded-md p-3 mb-4">
                                                    <p class="text-sm text-gray-700">
                                                        <strong>Notes:</strong> <?php echo e($topic->pivot->notes); ?>
                                            ...
                                            <div class="flex items-center justify-between">
                                                <a href="<?php echo e(route('topics.show', $topic->slug)); ?>" 
                        ...
                        <?php else: ?>
                            <div class="text-center py-12">
                                ...
                                <h3 class="text-xl font-semibold text-gray-900 mb-2">No completed topics yet</h3>
                                <p class="text-gray-600 mb-6">Start learning and mark topics as completed to track your progress!</p>
    ...
    <script>
        ...
        function toggleCompleted(topicId) {
            fetch(`/api/user/topics/${topicId}/completed`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
            ...
            .then(data => {
                if (data.success) {
                    // Reload the page to update the completed list
...
<?php endif; ?><?php /**PATH /homepages/38/d4299336130/htdocs/nephroapp/resources/views/profile/completed.blade.php ENDPATH**/ ?>