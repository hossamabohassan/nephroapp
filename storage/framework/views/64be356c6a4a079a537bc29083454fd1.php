            ...
            <div class="relative z-10 flex items-center justify-between py-8">
                <div class="text-white">
                    ...
                    <p class="text-red-100 mt-2 animate-slide-up">
                        <?php echo e($stats['favorites_count']); ?> favorite topics
                    </p>
                </div>
                ...
                <div class="flex items-center space-x-4">
                    <div class="text-right text-white">
                        <div class="text-2xl font-bold"><?php echo e($stats['favorites_count']); ?></div>
...
<?php endif; ?><?php /**PATH /homepages/38/d4299336130/htdocs/nephroapp/resources/views/profile/favorites.blade.php ENDPATH**/ ?>