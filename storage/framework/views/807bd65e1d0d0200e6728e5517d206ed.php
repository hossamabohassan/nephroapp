...
<?php $component->withAttributes([]); ?>
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="<?php echo e(route('admin.users.index')); ?>" class="inline-flex items-center px-3 py-2 bg-slate-600 text-white rounded-lg hover:bg-slate-700 transition-colors">
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm border border-slate-200">
            <form method="POST" action="<?php echo e(route('admin.users.store')); ?>" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input id="name" name="name" type="text" value="<?php echo e(old('name')); ?>" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
...
<?php endif; ?>
                    ...
                    <div>
                        ...
                        <input id="email" name="email" type="email" value="<?php echo e(old('email')); ?>" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                        <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
                    ...
                    <div class="grid gap-6 md:grid-cols-2">
                        <div>
                            ...
                            <select id="role" name="role" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                <option value="admin" <?php if(old('role') === 'admin'): echo 'selected'; endif; ?>><?php echo e(__('Admin')); ?></option>
                                <option value="editor" <?php if(old('role', 'member') === 'editor'): echo 'selected'; endif; ?>><?php echo e(__('Editor')); ?></option>
                                <option value="member" <?php if(old('role', 'member') === 'member'): echo 'selected'; endif; ?>><?php echo e(__('Member')); ?></option>
                            </select>
                            <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
...
<?php endif; ?>
                        ...
                        <div>
                            ...
                            <select id="is_active" name="is_active" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                <option value="1" <?php if(old('is_active', '1') == '1'): echo 'selected'; endif; ?>><?php echo e(__('Active')); ?></option>
                                <option value="0" <?php if(old('is_active') == '0'): echo 'selected'; endif; ?>><?php echo e(__('Inactive')); ?></option>
                            </select>
                            <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
...
<?php endif; ?>
<?php /**PATH /homepages/38/d4299336130/htdocs/nephroapp/resources/views/admin/users/create.blade.php ENDPATH**/ ?>