...
<?php $component->withAttributes([]); ?>
    ...
    <div class="flex items-center mb-6">
        ...
        <div>
            ...
            <p class="text-slate-600 mt-1">Update "<?php echo e($menuItem->title); ?>"</p>
        </div>
    </div>

    <!-- Form -->
    <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
        <form action="<?php echo e(route('admin.menu-items.update', $menuItem)); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
            <?php echo method_field('PUT'); ?>
            <?php echo $__env->make('admin.menu-items.form', ['menuItem' => $menuItem], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </form>
    </div>
...
<?php endif; ?>
<?php /**PATH /homepages/38/d4299336130/htdocs/nephroapp/resources/views/admin/menu-items/edit.blade.php ENDPATH**/ ?>